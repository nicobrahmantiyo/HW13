...
const Navbar = () => {
  ...
  return (
    <Flex w="full" as="nav" align="center" justify="space-between" wrap="wrap" padding="1rem" bgGradient="linear(to-l, #132043,#DDF2FD)" color="white">
      <Link to="/">
        <Flex align="center" mr={5} cursor="pointer">
          <Text bgGradient="linear(to-l, #7928CA, #FF0080)" bgClip="text" fontSize="xl" fontWeight="bold">
            Home
          </Text>
        </Flex>
      </Link>
